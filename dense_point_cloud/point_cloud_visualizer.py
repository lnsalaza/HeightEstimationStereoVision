...
if __name__ == "__main__":
    ...
    sparse_pcd_file = "./point_clouds/new_calibration_150_front_original.ply"
    centroid_file = "./point_clouds/new_calibration_150_front_centroids.ply"
    ...
    dense_pcd_file = "./point_clouds/new_calibration_150_front_dense.ply"
